...
$(function () {
    ...
    function bindKvlPopupEvents(isEdit) {
        ...
        if (isEdit) {
            ...
            //aliler changes New change for Add rigo without plate number 21032024 dileep Start
            if ($('#Trailer1Rego').val() !== '') {
            ...
            if ($('#Trailer4Rego').val() !== '') {
             ...
             //aliler changes New change for Add rigo without plate number 21032024 dileep end
