...
var allowedfiletypes = [".jpg", ".jpeg", ".png", ".bmp", ".pdf"];
...
(function ($) {
    ...
    $.fn.fileUpload = function () {
        return this.each(function () {
            ...
            var fileUploadId = "upload_complianceandlicanse_file"; //  `fileUpload-${++fileUploadCount}`;
            ...
            function createTable() {
                fileuploadinfotable = $(`
                <label class="mt-1 font-bold">Compliance Document</label>
                    <table>
                        <thead>
                            <tr>
                                <th></th>
