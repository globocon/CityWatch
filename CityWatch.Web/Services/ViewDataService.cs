...
namespace CityWatch.Web.Services
{
    ...
    public interface IViewDataService
    {
        ...
        Task<DataTable> KeyVehicleDocketToDataTable(List<DailyKeyvehicleLog> dailyPatrolData);
    }
            ...
            var sites = new List<DropdownItem>
    {
        ...
        public async Task<DataTable> KeyVehicleDocketToDataTable(List<DailyKeyvehicleLog> dailyPatrolData)
        {

            var dt = new DataTable("Key Vehicle");
            dt.Columns.Add("Day");
            dt.Columns.Add("Date", typeof(string)); // Use string to hold formatted date
            //  dt.Columns.Add("IR S/No");
            dt.Columns.Add("Control Room Job No.");
