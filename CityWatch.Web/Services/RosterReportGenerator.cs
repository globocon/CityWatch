                        ...
                        foreach (var site in groupSites.OrderBy(x => x.ClientSite.Name))
                        {
                            ...
                            for (int i = 0; i < 7; i++)
                            {
                                ...
                                foreach (var shift in dayShifts)
                                {
                                    ...
                                    // Add License Number - hidden for relief shifts: relief doesn't need a
                                    // licence and the extra line made the relief card taller than the others.
                                    if (!isRelief)
                                    {
                                        var license = shift.Guard?.SecurityNo ?? "N/A";
