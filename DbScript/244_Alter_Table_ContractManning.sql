ALTER TABLE [dbo].[ClientSiteRadioChecksActivityStatus]
ADD CRMSupplier nvarchar(MAX);

ALTER TABLE [dbo].[ClientSiteManningKpiSettings]
ADD CrmSupplier nvarchar(MAX);


/****** Object:  StoredProcedure [dbo].[sp_GetInActiveGuardDetailsForRC]    Script Date: 27-06-2024 00:04:57 ******/
SET ANSI_NULLS ON
GO
