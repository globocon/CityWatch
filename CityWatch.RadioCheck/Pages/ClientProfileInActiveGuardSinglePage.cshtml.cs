...
{
    public class ClientProfileInActiveGuardSinglePage : PageModel
    {
        ...
        public ClientProfileInActiveGuardSinglePage(IGuardLogDataProvider guardLogDataProvider, IOptions<EmailOptions> emailOptions,
